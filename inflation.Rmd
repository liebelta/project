...
usethis::use_git_config(
  user.name = "liebelta", # <-- change to your name
  user.email = "annika.liebelt@hu-berlin.de", # <-- and your email
...
```{r}
#usethis::create_github_token(description = "Token for Repro Workshop 2023 Test 2")
```
